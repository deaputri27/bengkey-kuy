...
const InputForm = () => {
  ...
  const [orders, setOrders] = React.useState([
    { id: 1, item: 'ban', qty: 0 },
    { id: 2, item: 'oli', qty: 0 },
    { id: 3, item: 'lampu', qty: 0 },
    { id: 4, item: 'air aki', qty: 0 },
    { id: 5, item: 'spion', qty: 0 },
    { id: 6, item: 'bumper', qty: 0 },
    { id: 7, item: 'bumper', qty: 0 },
    { id: 8, item: 'bumper', qty: 0 },
    { id: 9, item: 'bumper', qty: 0 },
    { id: 10, item: 'bumper', qty: 0 }
  ]);
